...
<pre style="position: relative;"><strong>Input:</strong> satisfaction = [-1,-8,0,5,-9]
...
Each dish is prepared in one unit of time.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> satisfaction = [4,3,2]
...
<pre style="position: relative;"><strong>Input:</strong> satisfaction = [-1,-4,-5]
